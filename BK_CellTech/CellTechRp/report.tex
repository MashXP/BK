...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.6\textwidth]{shrimp.jpg}
    \caption{Shrimp being dissected with the hepatopancreas (visible in red)}
    \label{fig:shrimp_dissection}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{hemo.jpg}
    \caption{Microscopic view of the hemocytometer grid during cell counting, with Trypan Blue used to distinguish non-viable cells.}
